"""
Secrets Agent — scans files for hardcoded secrets using gitleaks rules.

Copied from api/adk_agents/secrets_agent.py for standalone CLI usage.
Resolves data paths relative to project root.
"""
